...
const firstColumns: GridColDef[] = [
  { field: 'col1', headerName: 'ФИО студента', minWidth: 150, sortable: false, disableColumnMenu: true },
];
...
const lastColumns: GridColDef[] = [
  { field: 'col1', headerName: 'Н', minWidth: 50, sortable: false, disableColumnMenu: true },
  { field: 'col2', headerName: 'П', minWidth: 50, sortable: false, disableColumnMenu: true },
  { field: 'col3', headerName: 'Б', minWidth: 50, sortable: false, disableColumnMenu: true },
  { field: 'col4', headerName: 'Сумма \n пропусков', minWidth: 150, sortable: false, disableColumnMenu: true },
];
