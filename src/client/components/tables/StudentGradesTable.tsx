  ...
  const rows: GridRowsProp = [
    {
      ...
      col1: 6,
      col2: 3,
      col3: "Информационные технологии",
      col4: "Экзамен",
      col5: "Вахтин А. А.",
      col6: 40,
      col7: 40,
    ...
    },
    {
      ...
      col1: 6,
      col2: 3,
      col3: "Инфокоммуникационные системы и сети",
      col4: "Экзамен",
      col5: "Коваль А. С.",
      col6: 25,
      col7: 32,
      ...
      col9: 33,
      col10: 33,
      col11: "Удовлетворительно",
    },
    {
      id: 3,
      col1: 6,
      col2: 3,
      col3: "Технологии программирования ",
      col4: "Экзамен",
      col5: "Тарасов В. С.",
      col6: 45,
      col7: 25,
    ...
    },
    {
      ...
      col1: 6,
      col2: 3,
      col3: "Информационно-поисковые системы",
      col4: "Зачёт",
      col5: "Сычев А. В.",
      col6: 35,
      col7: 35,
    ...
    },
    {
      ...
      col1: 6,
      col2: 3,
      col3: "Обработка изображений",
      col4: "Зачёт с оценкой",
      col5: "Фертиков В. В.",
      col6: 36,
      col7: 35,
      col8: 37,
    ...
    },
    {
      ...
      col1: 6,
      col2: 3,
      col3: "Технологии интернет вещей",
      col4: "Зачёт",
      col5: "Зуев С. А.",
      col6: 30,
      col7: 30,
